...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (email === "admin@example.com" && password === "password") {
      // Store auth state in memory for demo
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 p-8">
          <div className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="block w-full px-4 py-3.5 text-gray-900 placeholder-gray-400 bg-white border border-gray-200 rounded-xl shadow-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent hover:border-gray-300"
            ...
            {error && (
              <div className="bg-red-50 border border-red-200 text-red-800 px-4 py-3 rounded-xl text-sm font-medium flex items-center">
